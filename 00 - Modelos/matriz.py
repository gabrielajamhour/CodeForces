...
Em seguida, j controla o deslocamento horizontal,
permitindo que os números sejam preenchidos de cima para baixo, movendo-se através das colunas.
Adicionando 1 a essa fórmula garante que os números sejam contados a partir de 1 em vez de 0
'''
