Tanya está aprendendo como diminuir um número em 1 unidade, mas ela faz isso errado com um número que consiste em dois ou mais dígitos. Tanya subtrai 1 de um número pelo seguinte algoritmo:  
